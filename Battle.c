...
void InitMoves(){
	NormalMoves[0] = (MoveType) {{"Vine Whip", "Látigo Cepa"}, Grass, CAT_PHYSICAL, 45};
	SignatureMoves[0] = (MoveType) {{"Petal Dance", "Baile Pétalo"}, Grass, CAT_SPECIAL, 120};
	...
	NormalMoves[3] = (MoveType) {{"Gust", "Ráfaga"}, Flying, CAT_SPECIAL, 40};
